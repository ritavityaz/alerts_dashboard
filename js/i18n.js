const translations = {
  ...
  he: {
    ...
    aboutTitle: "אודות",
    aboutWhat: "מה זה?",
    aboutWhatText: "טילים. מל\"טים. הפצצות. טראומה. אין שינה. עצבני. אוכלים יותר מדי. עצוב.\n\nפתרון? שינת הארי לא תעזור לכם. חייבים להתאמן. לקחת נוגדי דיכאון. להישאר במרחב מוגן.\n\nאבל לפחות תוכלו לכמת את הסבל שלכם.\n\nשינת הארי תראה לכם כמה פעמים השינה שלכם הופרעה, כדי שתוכלו להוכיח לבוס שאתם לא עצלנים, פשוט עייפים. ותוכלו להעריך את הזמנים הכי טובים להתקלח בלי לרוץ עירומים לממ\"ד ולהפחיד את הילדים.\n\nYMMV.\n\nהישארו בטוחים, ישנו טוב, ושהבאגים של ה-vibecode לא ינשכו אתכם.\n\nנ.ב: תרגום לפרסית לא זמין מסיבות מובנות.",
